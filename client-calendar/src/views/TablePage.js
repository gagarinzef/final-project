          ...
          <div className="w-96 mr-16">
            ...
            <div className="fixed bottom-0">
              <button
                ...
                className={`${!toggle ? 'animate-bounce' : 'animate-none'} inline-block px-24 py-2.5 bg-black text-white font-medium leading-tight rounded-md shadow-md 
              ...
              >
                ...
                {!toggle ?
                  <i className="fas fa-chevron-up px-2"></i> : <i class="fas fa-chevron-down px-2"></i>}
              </button>
              {toggle && (
