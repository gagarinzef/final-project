...
export default function SideNav({ handleSubmit }) {
  ...
  return (
    <>
      <nav
        className="md:left-0 md:block md:fixed md:top-0 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-nowrap md:overflow-hidden shadow-xl bg-pink-700 flex flex-wrap items-center justify-between relative md:w-64 z-10 py-4 px-6"
      >
        <div
        ...
        >
          ...
          <div
            className="cursor-pointer text-3xl md:block text-left md:pb-2 text-white mr-0 inline-block whitespace-nowrap uppercase font-bold p-4 px-0"
          >
            WOKITOUT
          </div>
          <div
          ...
          >
            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none text-left text-white">
              <li className="items-center mb-3 cursor-pointer" onClick={() => setShowModal(true)}>
                <div
