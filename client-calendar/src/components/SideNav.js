...
export default function SideNav({ proId }) {
  ...
  return (
    <aside className="w-56 mt-4 mb-60" aria-label="Sidebar">
        ...
        <ul className="space-y-2">
          <li>
            <button
              ...
              className="flex items-center rounded p-2 text-base font-normal text-gray-900 -lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
            >
              <svg
                aria-hidden="true"
